...
`
	...
	// GitHub templates
	githubIssueTemplate := `{
		"title": "{{.PromptName}} - {{.Metadata.date}}",
		"body": "## Generated by CronAI\n\n**Model**: {{.Model}}\n**Timestamp**: {{.Timestamp.Format "Jan 02, 2006 15:04:05"}}\n**Execution ID**: {{.ExecutionID}}\n\n{{if .Variables}}### Variables\n{{range $key, $value := .Variables}}- {{$key}}: {{$value}}\n{{end}}{{end}}\n\n### Content\n\n{{.Content}}\n\n---\n_Generated by CronAI using {{.Model}} model_",
		"labels": ["auto-generated", "cronai"]
	}`
	registerOrPanic(m, "default_github_issue", githubIssueTemplate)

	githubCommentTemplate := `{
		"body": "## AI Response\n\n**Model**: {{.Model}}\n**Timestamp**: {{.Timestamp.Format "Jan 02, 2006 15:04:05"}}\n**Prompt**: {{.PromptName}}\n\n{{.Content}}\n\n---\n_Generated by CronAI using {{.Model}} model_"
	}`
	...
	githubPRTemplate := `{
		"title": "{{.PromptName}} - {{.Metadata.date}}",
		"body": "## Generated by CronAI\n\n**Model**: {{.Model}}\n**Timestamp**: {{.Timestamp.Format "Jan 02, 2006 15:04:05"}}\n**Execution ID**: {{.ExecutionID}}\n\n{{if .Variables}}### Variables\n{{range $key, $value := .Variables}}- {{$key}}: {{$value}}\n{{end}}{{end}}\n\n### Content\n\n{{.Content}}\n\n---\n_Generated by CronAI using {{.Model}} model_",
		"head": "{{.Variables.head_branch}}",
		"base": "{{if .Variables.base_branch}}{{.Variables.base_branch}}{{else}}main{{end}}"
	}`
